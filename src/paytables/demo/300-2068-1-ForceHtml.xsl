...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/Paytable/PaytableData/ComponentsDataMapping">
		<html>
			<head>
				...
				{
					document.getElementById("DivisionSelection10.Scenario.D" + prevDivSection[0]).hidden = true;
					...
					document.getElementById("DivisionSelection10.Scenario.D" + divisionNum).hidden = false;
					prevDivSection[0] = divisionNum;
				}

				function divisionSelection50()
				{
					document.getElementById("DivisionSelection50.Scenario.D" + prevDivSection[1]).hidden = true;
				...
				{
					document.getElementById("DivisionSelection100.Scenario.D" + prevDivSection[2]).hidden = true;
				...
				{
					document.getElementById("DivisionSelection200.Scenario.D" + prevDivSection[3]).hidden = true;
				...
				{
					document.getElementById("DivisionSelection300.Scenario.D" + prevDivSection[4]).hidden = true;
				...
				{
					document.getElementById("DivisionSelection500.Scenario.D" + prevDivSection[5]).hidden = true;
				...
				{
					document.getElementById("DivisionSelection1000.Scenario.D" + prevDivSection[6]).hidden = true;
			...
			<body>
				...
				<form method="get" id="Force.Form10" hidden="false">
	...
	<xsl:template match="Entry" mode="Force.EntryIW">
		...
		<div id="{$groupID}.{$stageName}.{@name}" hidden="true">
			...
			<div class="panel">
				<input name="{$groupID}.{$stageName}.{@name}" type="text" />
			</div>
		</div>	
	</xsl:template>
