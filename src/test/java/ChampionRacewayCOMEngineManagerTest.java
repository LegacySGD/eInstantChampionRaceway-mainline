...
public class ChampionRacewayCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ChampionRacewayCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DerbyRunIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DerbyRunIW/InitOutcome.xml").getDocumentElement();
